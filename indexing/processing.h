...
void count_ngrams(tbb::concurrent_hash_map<std::string, int> &g_map_n,tbb::concurrent_hash_map<std::string, int> &g_map_n_1,const std::string &line, std::unordered_map<std::string,int> dict_eng, int n);

void index_string(safe_que<std::string> &queue, tbb::concurrent_hash_map<std::string, int> &g_map_n,tbb::concurrent_hash_map<std::string, int> &g_map_n_1,const std::unordered_map<std::string, int> &dict_eng, const std::string &ext, int n);
